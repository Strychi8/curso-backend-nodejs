...
export const getProductByIdService = async (id) => {
  const product = await readDocument("productos", id);
...
export const createProductService = async (producto) => await createDocument("productos", producto);
export const updateProductService = async (id, data) => await updateDocument("productos", id, data);
export const deleteProductService = async (id) => await deleteDocument("productos", id);